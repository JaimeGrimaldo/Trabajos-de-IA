...
# path de dataset
path_training = './C2A3_dataset/train'
path_validate = './C2A3_dataset/validation'
...
ax.axis('off')
ax.axis('tight')
plot.title('Matriz de confusión')
ax.table(cellText=cm, loc='center', colLabels=["croton","durazno","epazote","mango","morro"])
fig.tight_layout()
plot.show()
print('Classification Report')
cr = classification_report(img_training.classes, pred_y,
    target_names=["croton","durazno","epazote","mango","morro"])
print(cr)